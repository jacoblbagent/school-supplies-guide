...
export const gradeInfo: Record<string, GradeInfo> = {
  k:  { key: 'k', title: 'Kindergarten', subtitle: 'First school year · Play-based learning', description: 'Kindergarten is all about routines, social skills, and foundational literacy. Kids learn letter recognition, phonics, counting to 100, and basic shapes. Fine motor skills are a big focus — expect lots of cutting, gluing, and name-writing practice. Play-based exploration helps them adjust to structured school days while building curiosity and independence.', iconClass: 'grade-k' },
  '1': { key: '1', title: '1st Grade',     subtitle: 'Building reading & writing', description: 'First grade is where reading really takes off. Kids move from letter sounds to full sentences, build a sight-word vocabulary, and start writing short stories. Math covers addition/subtraction within 20, telling time, and place value. Expect longer assignments, homework routines, and more responsibility for keeping track of their own supplies.', iconClass: 'grade-1' },
  '2': { key: '2', title: '2nd Grade',     subtitle: 'More subjects, more independence', description: 'Second graders read chapter books, write paragraphs with proper punctuation, and tackle two-digit addition/subtraction. They explore measurement, money, and early geometry. Subjects broaden with more science and social studies. Independence grows — kids manage their own desk materials and take on classroom jobs that require reliable supplies.', iconClass: 'grade-2' },
  '3': { key: '3', title: '3rd Grade',     subtitle: 'The transition year', description: 'Third grade is a major shift — kids move from "learning to read" to "reading to learn." Multiplication, division, fractions, and cursive writing are introduced. State testing begins, and homework volume increases. Students switch between subjects more frequently and often have multiple teachers, making organized supplies and a sturdy backpack essential.', iconClass: 'grade-3' },
  '4': { key: '4', title: '4th Grade',     subtitle: 'Cursive, multiplication & beyond', description: 'Fourth graders tackle multi-digit multiplication, long division, fractions/decimals, and geometry. Reading comprehension deepens with chapter books, book reports, and research projects. Writing focuses on essays, persuasive pieces, and proper citations. Science covers ecosystems, energy, and the scientific method. A planner or binder system becomes very helpful.', iconClass: 'grade-4' },
  '5': { key: '5', title: '5th Grade',     subtitle: 'Middle school prep', description: 'Fifth grade prepares students for middle school with advanced math (order of operations, volume, coordinate planes), independent reading assignments, multi-paragraph essays, and collaborative science projects. Social studies covers US history and government. Organization is critical — students juggle multiple subjects, lockers, and changing classes. A locker shelf, sturdy binder system, and reliable supplies make the transition smoother.', iconClass: 'grade-5' },
};
...
function buildSupplies(grade: number): SupplyItem[] {
  ...
  const all: SupplyItem[] = [
    {
      icon: '🎒', name: 'Backpack', image: IMG.backpack, gendered: true, group: 'Carry & Store',
    ...
    {
      icon: '🍱', name: 'Lunchbox', image: IMG.lunchbox, gendered: true, group: 'Carry & Store',
    ...
    {
      icon: '✏', name: 'Pencils', image: IMG.pencils, gendered: false, group: 'Art & Writing',
    ...
    {
      icon: '🖍', name: 'Crayons', image: IMG.crayons, gendered: false, group: 'Art & Writing',
    ...
    {
      icon: '🖊', name: 'Markers', image: IMG.markers, gendered: false, group: 'Art & Writing',
    ...
    {
      icon: '🎨', name: 'Colored Pencils', image: IMG.colored, gendered: false, group: 'Art & Writing',
    ...
    {
      icon: '🧴', name: 'Glue', image: IMG.glue, gendered: false, group: 'Classroom Tools',
    ...
    {
      icon: '✂', name: 'Scissors', image: IMG.scissors, gendered: false, group: 'Classroom Tools',
    ...
    {
      icon: '📓', name: 'Notebooks', image: IMG.notebooks, gendered: false, group: 'Paper & Organize',
    ...
    {
      icon: '📁', name: 'Organization', image: IMG.folders, gendered: false, group: 'Paper & Organize',
    ...
    {
      icon: '⬜', name: 'Dry Erase Markers', image: IMG.expo, gendered: false, group: 'Classroom Tools',
    ...
    {
      icon: '🔆', name: 'Highlighters', image: IMG.highlighter, gendered: false, minGrade: 2, group: 'Classroom Tools',
    ...
    {
      icon: '📐', name: 'Ruler & Geometry', image: IMG.ruler, gendered: false, minGrade: 2, group: 'Classroom Tools',
    ...
    {
      icon: '📇', name: 'Index Cards & Notes', image: IMG.indexcards, gendered: false, minGrade: 2, group: 'Paper & Organize',
    ...
    {
      icon: '💧', name: 'Water Bottle', image: IMG.water, gendered: true, group: 'Carry & Store',
    ...
    {
      icon: '🎧', name: 'Headphones', image: IMG.headphones, gendered: true, minGrade: 3, group: 'Tech',
    ...
    {
      icon: '🧰', name: 'Pencil Case', image: IMG.pencilcase, gendered: true, group: 'Carry & Store',
