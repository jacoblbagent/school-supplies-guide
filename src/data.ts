import type { SupplyItem, GradeInfo } from './types';
...
// Images verified via Amazon product pages
const IMG = {
  ...
  return [
    {
      ...
      boy: [
        { name: 'Standard Kids Backpack', desc: 'Padded straps, multiple compartments, fits standard desks.', link: 'https://www.amazon.com/dp/B0CJ2XDTGH', rec: g <= 2 },
        { name: 'Character Print Backpack', desc: 'Fun themed print with the same quality and storage.', link: 'https://www.amazon.com/dp/B0CJ2XDTGH', rec: g > 2 }
      ],
      girl: [
        { name: 'Colorful Kids Backpack', desc: 'Bright pattern, padded straps, plenty of pockets.', link: 'https://www.amazon.com/dp/B0D91VX1RN', rec: g <= 2 },
        { name: 'Trendy Print Backpack', desc: 'Popular colors with a padded laptop sleeve for older grades.', link: 'https://www.amazon.com/dp/B0D91VX1RN', rec: g > 2 }
      ]
    },
    {
      icon: '🍱', name: 'Lunchbox', image: IMG.lunchbox, gendered: true,
      boy: [
        { name: 'Insulated Soft Lunchbox', desc: 'Soft-sided, insulated, easy-carry handle. Fits lunch + ice pack.', link: 'https://www.amazon.com/dp/B07D4CG3JW', rec: g <= 2 },
        { name: 'Hard Plastic Lunchbox', desc: 'Durable hard-shell with compartment tray. Keeps food separated.', link: 'https://www.amazon.com/dp/B07D4CG3JW', rec: g > 2 }
      ],
      girl: [
        { name: 'Insulated Soft Lunchbox', desc: 'Fun colors, insulated, lightweight. Fits lunch and ice pack.', link: 'https://www.amazon.com/dp/B0C5NSRKVR', rec: g <= 2 },
        { name: 'Bento-Style Lunchbox', desc: 'Compartmentalized bento bag with reusable ice pack.', link: 'https://www.amazon.com/dp/B0GXJX5HH1', rec: g > 2 }
      ]
    },
    {
      ...
      options: (g <= 2)
        ? [
            { name: 'Fat Primary Pencils', desc: 'Thick triangular grip designed for small hands.', link: 'https://www.amazon.com/dp/B07TCJPMKM', rec: true },
    ...
    },
    {
      ...
      options: (g <= 1)
        ...
        : [
            { name: 'Crayola 64-Count', desc: 'Big variety for bigger projects. Includes built-in sharpener.', link: 'https://www.amazon.com/dp/B00004TNSB', rec: true },
    ...
    },
    {
      ...
      options: (g <= 2)
        ? [
            { name: 'Broad Line Washable', desc: 'Classic broad tip, washable ink. Great for posters and big shapes.', link: 'https://www.amazon.com/dp/B00448JPTQ', rec: true },
        ...
        : [
            { name: 'Fine Line Markers', desc: 'Precise fine tips for diagrams, maps, and projects. 10 vivid colors.', link: 'https://www.amazon.com/dp/B07C7H6XMJ', rec: true },
    ...
    },
    {
      ...
      options: (g <= 1)
        ...
        : [
            { name: 'Pointed Tip Scissors 6"', desc: 'Precise pointed tips for detailed cutting. Stainless steel.', link: 'https://www.amazon.com/dp/B09M2TCXG3', rec: true },
      ...
      options: (g <= 1)
        ...
        : (g <= 2)
          ...
          : [
              ...
              { name: 'Wide Ruled Notebooks', desc: 'Wide ruled with bigger lines. Easier on the eyes.', link: 'https://www.amazon.com/dp/B0DZNYWX55', rec: false }
            ]
    },
    {
      ...
      options: (g <= 2)
        ...
        : [
            ...
            { name: '2-Pocket Folders (8-Pack)', desc: 'Classic color-coded folders. Simpler if binders aren\'t required.', link: 'https://www.amazon.com/dp/B07K8XVD11', rec: false }
          ]
    },
    {
    ...
    },
    {
      ...
      boy: (g <= 2)
        ? [
            ...
            { name: '16–18 oz Sport Bottle', desc: 'Slightly bigger with pop-top spout. Fits most backpack pockets.', link: 'https://www.amazon.com/dp/B0BN17SQRH', rec: false }
          ]
        : [
